...
import ca.unb.cs3035.project.figures.ChessPiece;
import ca.unb.cs3035.project.game.*;
...
public class Interface extends Application {
    ...
    private String DEFAULT_DARK_COLOR = "#769656";
    ...
    public String getButtonStyle() {
        return "-fx-font-weight: bold;\n" +
                ...
                "#769656,\n" +
                "#d86e3a,\n" +
                "radial-gradient(center 50% 50%, radius 100%, #eeeed2, #769656);\n" +
    ...
    private VBox generateMenuVBox() {
        ...
        VBox menu = new VBox();
        menu.setStyle("-fx-background-color: #769656");
    ...
    public void loadGame(byte[] gameContent, ChessBoardController ctrl) throws InterruptedException {
        ...
        try {
            ...
            vBox.setStyle("-fx-background-color: #769656;");
    ...
    private Pane generateHelpPane() {
        Pane pane = new Pane();
        pane.setStyle("-fx-background-color: #769656");
        ...
        scrollPane.setStyle("-fx-background: #769656;");
    ...
    private AnchorPane generateSettingsPane() {
        ...
        root.setStyle("-fx-background-color: #769656");
    ...
    private Pane generateAboutPane() {
        ...
        String imageURI = "images/logo.png";
        javafx.scene.image.Image image = new Image(Interface.class.getResourceAsStream(imageURI));
        ImageView imageView = new ImageView(image);
    ...
    private void initiateStartScreen() {
        try {
            Pane splashPane = FXMLLoader.load(getClass().getResource(("splash.fxml")));
            splashPane.setStyle("-fx-background-color: #769656");
