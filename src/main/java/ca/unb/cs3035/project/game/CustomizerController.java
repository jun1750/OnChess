...
import static ca.unb.cs3035.project.game.ChessBoardController.State.DRAG;
...
public class CustomizerController extends ChessBoardController{
    ...
    public CustomizerController(){
        ...
        cView.addEventHandler(MouseEvent.MOUSE_CLICKED, new CustomizerController.MouseHandler());
    }
